;(function() {
   ...
   var changeProductOrderData = function(target) {
       var product = myLib.closestItemByClass(target, 'product');
       ...
       order.querySelector('.order-data-title').setAttribute('value', productTitle);
       order.querySelector('.order-data-price').setAttribute('value', productPrice);
       order.querySelector('.order-data-size').setAttribute('value', productSize);
